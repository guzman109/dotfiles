...
local templates = {
	...
	["C++"] = {
		["justfile"] = justfile({
			...
			"configure-debug:",
			"\tjust deps-debug",
			"\tmeson setup build/debug --native-file build/debug/conan_meson_native.ini --reconfigure || meson setup build/debug --native-file build/debug/conan_meson_native.ini",
			"",
			"configure-release:",
			"\tjust deps-release",
			"\tmeson setup build/release --native-file build/release/conan_meson_native.ini --buildtype release --reconfigure || meson setup build/release --native-file build/release/conan_meson_native.ini --buildtype release",
			"",
			"build:",
		...
		["conanfile.py"] = {
			...
			'    generators = "MesonToolchain", "MesonDeps"',
			"",
			"    def layout(self):",
			"        meson_layout(self)",
		},
	...
	["Swift"] = {
		...
		["Package.swift"] = {
			...
			"    ],",
			"    targets: [",
			'        .executableTarget(name: "App", dependencies: ["AppCore"]),',
			'        .target(name: "AppCore"),',
		...
		["Tests/AppCoreTests/AppCoreTests.swift"] = {
			...
			"",
			"@Test func greetingReturnsMessage() async throws {",
